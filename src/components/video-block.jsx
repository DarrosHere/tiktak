...
function VideoBlock({ video, onLike, user, liked }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex flex-row items-end">
        ...
        <div
          className="relative bg-gray-900 rounded-2xl shadow-lg overflow-hidden flex flex-col justify-end w-full md:w-[750px] h-screen cursor-pointer"
        ...
        <div className="flex flex-col items-center ml-6 mb-8">
          ...
          >
            ...
            <span className="text-sm">
              {user ? (liked ? "Liked" : "Like") : "Login to like"}
            </span>
          </button>
        </div>
      </div>
